...
<pre>
    ...
    2. 178、當按下 ,,,x、,,,z 如果使用者設簡體字，就以簡體字模式轉出，反正就正體字
    3. 179、關掉 ,,,x、,,,z 複製貼上等內容，有點不穩定
...
<ul>
  ...
  <li>(Done 2023-03-31)178、當按下 ,,,x、,,,z 如果使用者設簡體字，就以簡體字模式轉出，反正就正體字</li>  
  <li>(Done 2023-03-31)179、關掉 ,,,x、,,,z 複製貼上等內容，有點不穩定</li>  
</ul>
<br>
