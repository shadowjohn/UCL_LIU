...
　　或同目錄下的tab檔。
    Version : 1.2 版，可支援 fcitx 裡的嘸蝦米表格：fcitx-table-boshiamy，<p style='color:red'>如要使用fcitx-table-boshiamy，下載 boshiamy.txt 改名成 fcitx_boshiamy.txt 跟主程式放一起，
    就可以把fctix_boshiamy.txt 轉成 liu.cin，再轉 liu.json 來使用。</p>
