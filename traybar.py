...
class SysTrayIcon(object):
    ...
    def shutdown(self):
        ...
        #print(dir(self._hicon))
        nid = (self._hwnd, 0)
        # From : https://github.com/jfoote/watchme/blob/master/systrayicon.py
        # Fix hide icon
        # By FeatherMountain
        ...
        #if self._message_loop_thread.isAlive():            
        #  self._message_loop_thread.join()
        #except:
        #  pass
    ...
    def _execute_menu_option(self, id):
        ...
        menu_params = self._menu_actions_by_params[id][1:]
        #print(menu_params)
        if menu_action == SysTrayIcon.QUIT:
            DestroyWindow(self._hwnd)
        else:
            menu_action(self,menu_params)
