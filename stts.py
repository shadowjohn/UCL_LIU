...
class kit:
    ...
    _TC_TDATA = u"""貝車夾見壯妝兒長東岡戔糾來侖兩門協亞軋狀訂訃計飛風負貞釓釔軌軍紇紅紀紉紈紆約紂後
...
逕鰁稅穀錟嚲廂齗呱覥鬮歎鱤蹠颺蓧勳蛻劈冊钜宮皰侶擼礄錈鴬鍈遊魘塚坰椏戩於襏屭"""
    _TC_CDATA = u"""贝车夹见壮妆儿长东冈戋纠来仑两门协亚轧状订讣计飞风负贞钆钇轨军纥红纪纫纨纡约纣后
...
骧缆躏鸬銮锣凿钻颞颧滟酽镢䦆镋棂鹦戆鹳骊郁鲡鹂鸾馕吁肷闹潆飖幞镙闳慭丢眦氲溆媪饥鲬龁虬瘘凑奂绬宁荙辍鳐脱莼镆贠鲉瑶辀珐兑锽廪捻羡阛奥
...
迳鳈税谷锬亸厢龂哌觍阄叹鳡跖飏莜勋蜕噼册鉅宫疱侣撸硚锩鸴锳游魇冢垧桠戬于袯屃"""
    ...
    _mTC_TDATA = []
    def __init__(self):
        self._mTC_CDATA = list(self._TC_CDATA.replace("\n",""));
        self._mTC_TDATA = list(self._TC_TDATA.replace("\n",""));
